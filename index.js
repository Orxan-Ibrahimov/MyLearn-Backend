...
const commentLikeRouter = require('./routes/comment-like');
...
app.use(`${API_URL}/subjects`, subjectRouter);
...
app.use(`${API_URL}/comment_likes`, commentLikeRouter);
...
app.use(`${API_URL}/enums`, enumsRouter);
